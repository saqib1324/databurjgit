...
Student.create!(:name => "Aimen Abdullah khan", :tracking_id => "2016-N-4012", :matric_percentage => "91.816", :monthly_income => "38000", :SEX => "F", :section => "D", :city => "Islamabad", :father_name => "Abdullah Khan", :DOB => "14/03/2000",  :email => "aimen@hotmail.com", :phone_number => "0300-1253567", :secondary_phone_number => "042-37153453", :mailing_address => "H. No. E-850/C, Nishat Colony Lahore cantt", :username => "std6", :password => "std6")
Student.create!(:name => "Hashim Haider", :tracking_id => "2016-N-5012", :matric_percentage => "91.486", :monthly_income => "36000", :SEX => "M", :section => "C", :city => "Sanghar", :father_name => "Haider ahmed", :DOB => "26/08/1996",  :email => "haider@gmail.com", :phone_number => "0300-1253567", :secondary_phone_number => "042-37153453", :mailing_address => "H. No. E-850/C, Nishat Colony Lahore cantt", :username => "std7", :password => "std7")
Student.create!(:name => "Junaid Haroon Siddiqui", :tracking_id => "2016-N-3452", :matric_percentage => "90.86", :monthly_income => "34000", :SEX => "M", :section => "A", :city => "Mianwali", :father_name => "Haroon Askari", :DOB => "24/02/1999",  :email => "junaid@lums.com", :phone_number => "0300-1253567", :secondary_phone_number => "042-37153453", :mailing_address => "H. No. E-850/C, Nishat Colony Lahore cantt", :username => "std8", :password => "std8")
Student.create!(:name => "Shazia Saleem rana", :tracking_id => "2016-N-7012", :matric_percentage => "85.346", :monthly_income => "67000", :SEX => "F", :section => "B", :city => "Lahore", :father_name => "Muqsit saleem", :DOB => "26/08/1994",  :email => "ranag@gmail.com", :phone_number => "0300-1253567", :secondary_phone_number => "042-37153453", :mailing_address => "H. No. E-850/C, Nishat Colony Lahore cantt", :username => "std9", :password => "std9")
Student.create!(:name => "Muhammad Affan Ahmed", :tracking_id => "2016-N-4512", :matric_percentage => "88.86", :monthly_income => "28000", :SEX => "M", :section => "B", :city => "Sakhar", :father_name => "Askari khan", :DOB => "26/08/1994",  :email => "sohail@gmail.com", :phone_number => "0300-1253567", :secondary_phone_number => "042-37153453", :mailing_address => "H. No. E-850/C, Nishat Colony Lahore cantt", :username => "std10", :password => "std10")
Student.create!(:name => "Hadiqa khan", :tracking_id => "2016-N-5013", :matric_percentage => "95.186", :monthly_income => "40000", :SEX => "F", :section => "A", :city => "Bahawalpur", :father_name => "Khan haq", :DOB => "26/08/1994",  :email => "sohail@gmail.com", :phone_number => "0300-1253567", :secondary_phone_number => "042-37153453", :mailing_address => "H. No. E-850/C, Nishat Colony Lahore cantt", :username => "std11", :password => "std11")
Instructor.create!(:instructor_id => "2", :instructor_name => "Basit Shafiq", :email => "basit.shafiq@lums.edu.pk", :phone_number => "0345-8978679", :subject_name => "Operating Systems", :username => "inst1", :password => "inst1")
Instructor.create!(:instructor_id => "3", :instructor_name => "Shafay Shamail", :email => "shafay.shamail@lums.edu.pk", :phone_number => "0345-8978679", :subject_name => "E-Governement", :username => "inst2", :password => "inst2")
Instructor.create!(:instructor_id => "4", :instructor_name => "Ihsan Ayub qazi", :email => "ihsan.ayub@lums.edu.pk", :phone_number => "0345-812334", :subject_name => "Data Structures", :username => "inst3", :password => "inst3")
Instructor.create!(:instructor_id => "5", :instructor_name => "Murtaza Taj", :email => "taj@lums.edu.pk", :phone_number => "0345-8978679", :subject_name => "Operating Systems", :username => "inst4", :password => "inst4")
Instructor.create!(:instructor_id => "6", :instructor_name => "Hamid Abdul Basit", :email => "ab@lums.edu.pk", :phone_number => "0345-8978679", :subject_name => "Software Engineering", :username => "inst5", :password => "inst5")
Instructor.create!(:instructor_id => "7", :instructor_name => "Asim karim", :email => "asim.karim@lums.edu.pk", :phone_number => "0345-8978679", :subject_name => "Service Oriented Computing", :username => "inst6", :password => "inst6")
Section.create!(:section_name => "A", :room_location => "A-14")
Section.create!(:section_name => "B", :room_location => "A-13")
Section.create!(:section_name => "C", :room_location => "A-01")
Section.create!(:section_name => "D", :room_location => "A-02")
Section.create!(:section_name => "E", :room_location => "A-04")
Section.create!(:section_name => "F", :room_location => "A-12")